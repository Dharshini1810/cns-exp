...
class playFairCipher {
    public static String generatePlaintext(String pt) {
        ...
        // pair the letters, if a pair conatins same character, introduce new character
        // 'x'
    ...
    public static String getNewPosition(char ch1, char ch2, char[][] m) {
        ...
        // check for condition: if both char are present in same row/same col/diff row
        // and col
    ...
    public static void main(String[] args) {
        ...
        // Generation of pt1 --> plain text which contains characters that are not
        // present in key
        ...
        for (int i = 0; i < 26; i++) {
            ...
            if (!(ch.equals("i") || ch.equals("j")) && !(key.contains(ch))) {
                pt1 += ch;
            }
        ...
        // generte new plain text message(pairing up the elements and introducing new
        // variable 'x')
